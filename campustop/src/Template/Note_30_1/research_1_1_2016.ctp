...
<div class="col-md-8 form-group">
                                ...
                                <div class="col-md-12" style="">
                                    <div class="col-md-11"> 
                                        <input type="hidden" name="finaltotalresearchprice" id="finaltotalresearchprice">
...
$(function(){
  ...
  var count = 1;
    ...
    data.submit().always(function () {
      ...
      file_txt.append('<input type="radio" name="choice" onclick="showresearchfree('+(count)+')" id="free'+(count)+'"> i would like to charge  <input type="radio" name="choice" onclick="showresearchcharge('+(count)+')" id="researchcharge'+(count)+'" onload="showresearchcharge('+(count)+')"> Nah! i would give it free ');
