              ...
              <div class="col-md-12">
                ...
                <div class="navbar-collapse collapse">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="mega-menu">
                      <a href="<?= SITEURL; ?>privacypolicy">Privacy Policy</a>
                    </li>
                    <li class="mega-menu">
                    ...
                    <li class="hidden-767">
                      <button class="sample btn custom large b" data-h="36" data-s="100" data-l="50" ,="" data-p="10" style="background-color: #ffc400;">Registration</button>
                    </li>
                  </ul>
                  <!-- Right nav -->
