                                            ...
                                            <p class="form-message" style="display: none;"></p>
                                                <div class="contact-form">
                                                    ...
                                                    <?php  //$this->Form->create($profile,array('controller' => 'Profile','action' => 'addhardskill')) ?>
                                                     <form id="hardskillform" method="post" action="addhardskill">
                                                        <div>
                                                            <div style="padding-bottom:2%"> 
                                                                    ...
                                                                    <select name="hard_skill_flag" required="required" style="float:right">
                                                                         <option value="1" <?php if($skill['hard_skill_flag']==1){ echo "selected";}?>>public</option>
                                                                         <option value="0" <?php if($skill['hard_skill_flag']==0){ echo "selected";}?>>private</option>     
                                                                    </select>
                                                ...
                                                <div class="contact-form"  style="padding-top:2%">
                                                    <?= $this->Flash->render('positive') ?>
                                                       <?php //$this->Form->create($skill,array('controller' => 'Profile','action' => 'addinterest')) ?>
                                                        <!-- Field 1 -->
                                                        <form id="interestform" method="post" action="addinterest">
                                                        <div>
                                                              <div style="padding-bottom:2%"> 
