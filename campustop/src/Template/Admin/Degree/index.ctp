                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						<div class="panel-heading" style="align:right">
                            <?php  echo $this->Html->link('Add Degree',['controller' => 'Degree', 'action' => 'add'],['class'=>"btn btn-default"]); ?>
									...
									<div class="table-responsive">
										<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
												<table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="dataTables-example_info">
													...
													<?=$this->Html->link( 'Edit', ['controller' => 'Degree','action' => 'edit', $list['degree_id']] ); ?>  |  <?= $this->Form->postLink('Delete',['action' => 'delete', $list['degree_id']],['confirm' => 'Are you sure?'])?>
