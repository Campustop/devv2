													                             ...
													                             ?>
													                                    <tr class="gradeA odd">
																		                    ...
																		                    <td class="sorting_1"><?php if($list['newslatter_status']=="S")
																		                    							{?>
																		                    								<a href='#' onclick='confirm_inactive("<?php echo $list['newslatter_status']; ?>","<?php echo $list['newslatter_id']; ?>")'><img src='<?= SITEURL; ?>webroot/img/status.gif'/></a>
																		                    					<?php	}
																		                    							else
																		                    							{?>
																		                    									<a href='#' onclick='confirm_inactive($list["<?php echo $list['newslatter_status']; ?>","<?php echo $list['newslatter_id']; ?>")'><img src='<?= SITEURL; ?>webroot/img/unstatus.gif'/></a>
																		                    					<?php	} ?></td>
																		                </tr>
																		<?php endforeach; ?>
																	<?php 	} ?>
