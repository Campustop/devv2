                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="contact-form">
                                ...
                                <?= $this->Form->create($contact,['name'=>'contactus','id'=>'contactus']) ?>
                                        <!-- Field 1 -->
                                ...
                                <?php
                    echo $this->Form->button('Submit', array('type' => 'submit','class'=>'myButton','id'=>'contactbutton'));
                    echo $this->Form->end(); 
                    ...
                    ?>
                        ...
                        <div class="col-md-6 ">
                                ...
                                <div class="contact-text"><h2 class="" >You can also give us a call</h2>
