                       ...
                       <a class="dropdown-toggle" href="#" data-toggle="dropdown" id="navLogin">Login</a>
                          <div class="dropdown-menu" style="padding:17px;min-width: 300px;max-width: 400px;left: -180%;" id="loginmenu">
                                  ...
                                  <?php // $this->Form->create(['controller' => 'home','action' => 'login']); ?>
                                     <form method="post" action="home/login" name="loginform" id="loginform">
                                      ...
                                      <div class="clearfix"></div>
                                        <?php echo $this->Form->button('Login', array('type' => 'submit','class'=>'myButton hvr-grow small-text','id'=>'registerbtn','style'=>' rgba(0, 0, 0, 0) url("../../select2.png") no-repeat scroll 0 1px; '));?>
                                      <div  class="text-center">
                                        <span class="pull-left small-text text-center" style="margin-top:15px; text-align:center;">
                                        Forgot Password? Its Ok! <a href="<?= SITEURL; ?>forgotpassword" class="text-color"><u> RECOVER HERE </u></a>
                                      </span> 
                                      </div>
