...
<hr class="hrstyle"/>
      <div class="col-md-12 form-group">
        ...
        <div class="col-md-12" style="">
            ...
            <div class="col-md-11"> 
            <input type="hidden" name="finalcaseprice" id="finaltotalcaseprice">
...
$(function(){
  ...
  var count = 1;
    ...
    data.submit().always(function () {
      ...
      file_txt.append('<input type="radio" name="choice" onclick="showfree('+(count)+')" id="free'+(count)+'"> i would like to charge  <input type="radio" name="choice" onclick="showcharge('+(count)+')" id="casecharge'+(count)+'" onload="showcasecharge('+(count)+')"> Nah! i would give it free ');
