                                        ...
                                        <div class="col-md-4">
                                         <label >Field:</label> 
                                          ...
                                          <div class="col-md-8">
                                              ...
                                              <div style="display:none;" id="fieldsmessageblank"><i class="form-control-feedback fa fa-times" data-bv-icon-for="program_id" style="cursor: pointer;color: #a94442;" data-original-title="" title=""></i></div>
