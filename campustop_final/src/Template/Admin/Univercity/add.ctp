<div class="page-content">
    <!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
          <div class="row">
				...
				<?= $this->Form->create($univercity) ?>
					<tr>
						<td>
							<label>Univercity Name:</label>
						</td>
						<td>
							<?php echo $this->Form->input('univercity_name', array('type' => 'text', 'label' => false)); ?>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<?php echo $this->Form->select('country_id', $country,['empty' => '(choose one)']); ?>
						</td>
					</tr>
					<tr>
						<td>
