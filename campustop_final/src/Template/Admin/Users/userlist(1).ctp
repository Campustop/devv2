										...
										<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
												<table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="dataTables-example_info">
					                						...
					                						<thead>
																	...
																	<th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 500px;" aria-sort="ascending" aria-label="Country">Country</th>
													                           ...
													                           // die;
													                             ?>
													                                    <tr class="gradeA odd">
													                                        ...
													                                        <td class="sorting_1"><?php echo $list['fname']; ?></td>
													                                        <td class="sorting_1"><?php echo $list['username']; ?></td>
													                                        <td class="sorting_1"><?php echo $list['countrys']['country_id']; ?></td>
													                                        
	<td class=" "> <?=$this->Html->link( 'View', ['controller' => 'Users','action' => 'viewadmin', $list['user_id']] ); ?>  |  <?= $this->Form->postLink('Delete',['action' => 'delete', $list['user_id']],['confirm' => 'Are you sure?'])?>
