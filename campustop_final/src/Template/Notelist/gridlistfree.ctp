      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
              <a href="<?=SITEURL; ?>notelist/gridlistfree"><button class="btn btn-default active" type="button" style="padding: 9px 14px;">Free</button></a>
            </div>
            <div class="col-md-4">
          ...
          <div role="tabpanel" class="tab-pane active" id="grid" >
            ...
            <div class="masonry-grid grid-col-4">
              ...
              <!-- Item 1 -->
               ...
               <?php if(count($gridfree)>0)

                              {
                                ?>
                <?php foreach ($gridfree as $note)
                      {
