  ...
  <script src="<?= SITEURL; ?>webroot/js/bootstrap.min.js"></script>
    ...
    <script src="<?= SITEURL; ?>webroot/js/bootstrapValidator.min.js"></script>
     ...
     <script src="<?= SITEURL; ?>webroot/js/bootstrap-select.js"></script>
	  ...
	  <script src="<?= SITEURL; ?>webroot/js/jquery.noty.js"></script> 
          <script src="<?= SITEURL; ?>webroot/js/layouts/top.js"></script> 
          <script src="<?= SITEURL; ?>webroot/js/layouts/center.js"></script> 
          <script src="<?= SITEURL; ?>webroot/js/layouts/bottom.js"></script> 
          <script src="<?= SITEURL; ?>webroot/js/layouts/inline.js"></script> 
         <script src="<?= SITEURL; ?>webroot/js/themes/default.js"></script>
