  ...
  border: 1px solid #00a65a;
        ...
        <section class="page-section">
            <div class="container">
			 ...
			 echo $this->Flash->render('negative1');
                        if($this->request->session()->read('positive')!="")
                        		{?>
                            		...
                            		<?= $this->Form->create($register,['name'=>'register','id'=>'register','action'=>'add']) ?>
												...
												<div class="row" role="form">
													...
													<div class="col-md-4 input-text form-group">
														...
														<input class="input-name form-control" type="text" name="middlename" id="middlename" placeholder="Middle Name" /> 
													</div>
													<div class="col-md-4 input-text form-group">
              ...
              <input class="input-email form-control" type="email" name="username" id="useremail" placeholder="Email" />
												...
												<div class="row" role="form">
													<div class="col-md-6 input-email form-group">
														...
														<select name="country" id="country" class="form-control" data-show-icon="true">
							                                    <option>Select country</option>
							                                     <?php 

							                                     foreach ($country as $list):
							                                      ?>
							                                              <option data-content="<i class='fa fa-flag-sa'></i>" value="<?php echo $list['country_id']?>" >
              ...
              <input class="input-email form-control" type="email" name="username1" placeholder="Email"/>
												...
												<div class="row" role="form">
													<div class="col-md-6 input-email form-group">
														<label class="sr-only">Country</label> 
														<select name="country1" id="country" class="form-control" data-show-icon="true">
							                                    <option>Select country</option>
							                                     <?php 
													...
													<div class="col-md-6 input-email form-group">
														...
														<input type="hidden" class="form-control" name="role1" value="5" />
														<?php echo $this->Form->hidden('created_dt', ['value'=>time()]); ?>
													</div>
												</div>
												<div class="row" role="form">
...
<script type="text/javascript">
 $(document).ready(function(){
    ...
    {  
		 ...
		 $.ajax({
               type:"POST",
               url:"<?php echo SITEURL.'register/resetsession';?>",
