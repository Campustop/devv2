...
<footer id="footer">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 widget bottom-xs-pad-20">
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?= SITEURL; ?>faq">Order History</a>
                                    </li>
                                    <li>
                                        <a href="<?= SITEURL; ?>faq">Shopping Cart</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="clearfix"></div>
                                 <div id="message" class='alert alert-success' style="display:none">
                                    ...
                                    <label> This email is subscribed newsletter.</label>
                                  </div>
                                   <div id="errormessage" class='alert alert-warning' style="display:none">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <label> This email is already subscribed.</label>
                                  </div>
                                <form id="subscribe_form" action="" method="post" name="subscribe_form" role="form">
                                    ...
                                    <button class="submit bg-color" type="button">
            ...
            <div class="copyright">
                <div class="container">
                    <div class="row">
                        <!-- Copyrights -->
                        <div class="col-xs-10 col-sm-6 col-md-6"> &copy; 2015 <a href="http://cs.spunktek.com/campustop">AKMYDH Inc. </a>
                        <br />
                        <!-- Terms Link -->
                         
                        <a href="<?= SITEURL; ?>termsofuse">Terms of Use</a> / 
                        <a href="<?= SITEURL; ?>privacypolicy">Privacy Policy</a></div>
   ...
   <script type="text/javascript">
    ...
    {  
        if ($('#subscribe_form').valid()) // check if form is valid
        {
              var form = $('#subscribe_form');
            
              $.ajax({
               type:"POST",
               url:"<?php echo SITEURL.'home/subscribenewsletter';?>",
               data:  form.serialize(),
