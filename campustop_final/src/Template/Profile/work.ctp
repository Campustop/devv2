                                                    ...
                                                    ?>
		                                            		<div id="workid1" class="workdiv col-md-12"  style="float:left;">
					                                            		...
					                                            		<div class="col-md-12 form-group">
					                                                        <div class="col-md-4">
					                                                        	<span style="font-size: 14px; color:#555;">I have working in :<sup>*</sup></span>
					                                                        </div>
					                                                        <div class="col-md-8">
					                                                    ...
					                                                    <div class="col-md-12 form-group">
					                                                    	...
					                                                    	<div class="col-md-4">
					                                                        	<span style="font-size: 14px; color:#555; " class="work">This job was :<sup>*</sup></span>
					                                                        </div>
					                                                        <div class="col-md-8">
					                                                    ...
					                                                    <div class="col-md-12 form-group">
					                                                    	...
					                                                    	<div class="col-md-4">
					                                                        	<span style="font-size: 14px; color:#555; " class="work">This worked on :<sup>*</sup></span>
					                                                        </div>
					                                                        <div class="col-md-8">
					                                                    ...
					                                                    <div class="col-md-12 form-group">
					                                                    	...
					                                                    	<div class="col-md-4">
					                                                        	<span style="font-size: 14px; color:#555; " class="">I worked from :<sup>*</sup></span>
					                                                        </div>
					                                                        <div class="col-md-8">
					                                                    ...
					                                                    <div class="col-md-12 form-group">
					                                                    	...
					                                                    	<div class="col-md-4">
					                                                        	<span style="font-size: 14px; color:#555;" class="work">The insights i gained from this work experience :<sup>*</sup></span>
					                                                        </div>
					                                                        <div class="col-md-8">
                                            ...
                                            <?php   }
					                                ...
					                                <div id="workid1" class="workdiv col-md-12"  style="float: left;">
		                                                    ...
		                                                    <div class="col-md-12 form-group">
		                                                        ...
		                                                        <div class="col-md-8">
		                                                       		<select name="job[]"  style="float:centter;" class="input-email form-control">
		                                                                 	<option value="">Select job</option>
    ...
    $(document).ready(function(){
      var count = 1;
	     ...
	     $("#addwork").click(function () {
	        ...
	        var y = $('#workdetails').first().clone();
	        y.find(":input").val(''); //id-selector to be used also clone it
	
	         $(y).insertAfter($('#workdetails').last());
	    });
